...
export const PERMISOS_MODULOS = {
  ...
  licencias:        ['admin', 'rrhh'],
  legajo:           ['admin', 'rrhh'],
  entrevistas:      ['admin', 'rrhh'],
  egresos:          ['admin', 'rrhh'],
  contratos:        ['admin', 'rrhh'],
  calendario:       ['admin', 'rrhh', 'supervisor_movil', 'supervisor_fibra', 'supervisor_atencion'],
  pausas_vicidial:  ['admin', 'supervisor_movil', 'supervisor_fibra'],
  tiempo_llamadas:  ['admin', 'supervisor_movil', 'supervisor_fibra', 'supervisor_atencion', 'rrhh'],
...
export const MODULO_LABELS: Record<ModuloSistema, string> = {
  ...
  egresos:          'Egresos',
  contratos:        'Armado de Contratos',
  calendario:       'Calendario',
  pausas_vicidial:  'Pausas Vicidial',
  tiempo_llamadas:  'Tiempo de Llamadas',
